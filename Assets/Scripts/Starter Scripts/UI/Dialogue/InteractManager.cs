...
public class InteractManager : MonoBehaviour
{
    ...
    */
	...
	[HideInInspector]
	public InteractDialogue currentTrigger;
	...
	public void StartDialogue(Queue<string> dialogue, bool endGame)
	{
		isInDialouge = true;
		...
		PrintDialogue(endGame); // Prints out the first line of dialogue
	}

	public void AdvanceDialogue(bool endGame) // call when a player presses a button in Dialogue Trigger
	{
		PrintDialogue(endGame);
	}

	private void PrintDialogue(bool endGame)
	{
		...
		else if (inputStream.Peek().Contains("[NAME=")) //Set the name of the speaker
		{
			...
			NameText.text = name;
			PrintDialogue(endGame); // print the rest of this line
		}
	...
	public void EndDialogue(bool endGame)
	{
		TextBox.text = "";
		NameText.text = "";
		inputStream.Clear();
